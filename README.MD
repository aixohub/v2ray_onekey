...
```bash
wget -N --no-check-certificate -q -O v2ray-ss.sh "https://raw.githubusercontent.com/aixohub/v2ray_onekey/main/v2ray-ss.sh" && chmod +x v2ray-ss.sh && bash v2ray-ss.sh
```
