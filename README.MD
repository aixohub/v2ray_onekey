...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/aixohub/Xray_onekey/main/wg-install.sh" && chmod +x wg-install.sh && bash wg-install.sh
```
