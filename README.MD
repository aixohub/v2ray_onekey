...
```
wget -N --no-check-certificate -q -O install.sh "https://raw.githubusercontent.com/aixohub/v2ray_onekey/main/install-v2ray.sh" && chmod +x install.sh && bash install.sh
```
